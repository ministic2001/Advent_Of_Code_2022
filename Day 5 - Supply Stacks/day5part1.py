...
class CrateStack:
    ...
    def push(self, crate: str) -> None:
        """
        Add a crate at the top of the crate stack
        
        crate: The crate to be added on the top of stack
        """
        self.crates.append(crate)
    
    def pop(self) -> str:
        """
        Remove the crate at the top of crate stack

        return: The crate that is removed from top of crate stack
        """
    ...
    def move_crates(self, other_crate_stack, move_count: int) -> None: # Class Type hinting only at 3.11
        ...
        for _ in range(move_count):
            other_crate_stack.push(self.pop())
